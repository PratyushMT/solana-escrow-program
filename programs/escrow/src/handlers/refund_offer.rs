...
pub struct RefundOffer<'info> {
    pub token_program: Interface<'info, TokenInterface>, //work with either the classic token program or the newer token extensions program
